      ...
      <div className="min-h-[880px] overflow-hidden">
        <div className="flex flex-col md:flex-row gap-4 h-full">
          <div className="flex flex-col items-center justify-center rounded-md p-6 md:w-1/2">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center uppercase xl:text-9xl xl:text-start">
              Nuestro equipo docente!
            </h1>

            <p className="hidden md:block text-center text-xl md:text-2xl lg:text-3xl pt-20 xl:text-start xl:text-5xl">
          ...
          <div className="flex flex-col md:flex-row gap-2 mb-8 h-auto md:w-1/2 xl:min-h-screen xl:p-28 xl:m-0">
            <div className="grid grid-cols-2 gap-[10px] sm:gap-[20px] msm:gap-[25px] xl:gap-[30px] w-full md:p-[50px]">
              <div className="row-span-3 flex items-center justify-center w-full h-auto rounded-md shadow-[0px_0px_6px_rgba(0,0,0,8)] mb-4">
                <img
              ...
              <div className="flex items-center justify-center rounded-md shadow-[0px_0px_6px_rgba(0,0,0,8)] mb-4">
                <img
              ...
              <div className="flex items-center justify-center max-h-[100vh] rounded-md shadow-[0px_0px_6px_rgba(0,0,0,8)] mb-4">
                <img
