...
export default function Home() {
  return (
    <Element
      name="Home"
      className="relative min-h-screen bg-[url('./src/assets/IMG-HOME-PRINCIPAL-MOVILE.png')] bg-cover bg-center flex justify-center items-center md:bg-[url('./src/assets/IMG-HOME-PRINCIPAL.jpg')]"
    >
      ...
      <div className="relative flex flex-col items-start w-full pl-1 msm:pl-10">
        <div className="mb-44">
          <h1 className="text-black font-bold sm:text-5xl md:text-8xl lg:pt-10 xl:pt-10 xl:pl-32 lg:text-9xl text-left uppercase">
        ...
        <div className="mx-auto -ml-1/2 -mr-1/2 translate-y-35 xl:translate-y-20 ">
          <button className="bg-black text-white font-bold p-4 xl:p-6 xl:text-xl sm:translate-y-24 xl:translate-y-2 rounded-3xl transition-all duration-300 hover:bg-gray-800 hover:scale-105 flex items-center">
            <p className="xl:text-5xl mr-4 uppercase">inscripciones 2025</p>
            <img
              src="../../src/assets/ICON-CHECK.png"
              alt="icon-check"
